...
%% 在不同声源数目下进行定位
 for ii=1:length(NumU)
    ...
    for Num=10:10:80
        ...
        nm=0;
        for i=1:M           
            SLocation=round(rand(AS,2)*500); %多个声源位置分布500*500
