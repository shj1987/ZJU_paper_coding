...
figure(1)
subplot(2,1,1)
plot(Sigma,PLE_P,'m>--',Sigma,PBIAS,'b*--', Sigma, MPBIAS,'rd--', Sigma, WIV_PB,'g+--','linewidth',1.5)
%plot(Sigma,PLE_P,'m--',Sigma,PBIAS,'b-.', Sigma, MPBIAS,'r*--', Sigma, WIV_PB,'g+--','linewidth',1.5)
set(gca,'Fontsize',13);
h=legend('AVPLE','BCAVPLE','ML','BCAVPLE-WIV');
set(h,'Fontsize',12)
...
subplot(2,1,2)
plot(Sigma,PLE_H,'m>--',Sigma,HBIAS,'b*--', Sigma, MHBIAS,'rd--', Sigma, WIV_HB,'g+--','linewidth',1.5)
